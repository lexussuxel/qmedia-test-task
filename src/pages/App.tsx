...
function App() {
  ...
  return (
    <>
      ...
      <p className={styles.paragraph}>Пройдите короткий тест и получите список наиболее подходящих
        для вас косметических продуктов
      </p>
      <Quiz question={QUIZ_QUESTIONS[currentQuestion]} next={next} prev={prev} count={QUIZ_QUESTIONS.length} checked_num={answers[currentQuestion]}/>
    </>
  );
}
